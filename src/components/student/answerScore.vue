    ...
    <div class="total">
      ...
      <div class="show">
        <div class="img1" :class="{'img1Transform': imgShow}">
           <img :src="imgSrc.fail2" alt="哭了" v-if="score < totalScore">
          <img :src="imgSrc.pass2" alt="过了" v-if="score >= totalScore">
        </div>
...
export default {
  data() {
    return {
      ...
      imgSrc: {
        ...
        pass2: require('@/assets/img/good2.png')
      },
  ...
  methods: {
    ...
    getScore() {
      ...
      let scoreData = this.$route.query.scoreData
